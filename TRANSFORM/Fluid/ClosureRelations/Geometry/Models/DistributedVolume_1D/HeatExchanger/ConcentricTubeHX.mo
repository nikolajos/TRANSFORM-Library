...
model ConcentricTubeHX
  ...
  parameter SI.Area crossAreaEmpty_shell = 0.25*pi*D_o_shell^2 "Cross-sectional area of an empty shell (i.e., no tubes)"
    annotation(Dialog(tab="Shell Side",group="Inputs"));
  parameter SI.Length perimeterEmpty_shell = pi*D_o_shell "Wetted perimeter of an empty shell (i.e., no tubes)"
    annotation(Dialog(tab="Shell Side",group="Inputs"));
...
protected
  parameter SI.Area crossAreaNew_shell = crossAreaEmpty_shell-0.25*pi*D_o_tube^2 "Cross-sectional flow area of shell";
  parameter SI.Length perimeterNew_shell = perimeterEmpty_shell + pi*D_o_tube "Wetted perimeter of shell";
equation
